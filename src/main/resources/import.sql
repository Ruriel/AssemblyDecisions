...
INSERT INTO AGENDA(id, name, description, enabled, created_at) VALUES (2, 'Agenda 2', 'Second agenda of the week.', true, current_timestamp);
INSERT INTO AGENDA(id, name, description, enabled, created_at) VALUES (3, 'Agenda 3', 'Third agenda of the week.', true, current_timestamp);
